...
builtin=data_k.groupby( ['id', pd.Grouper(key='time', freq='1H')] )["appCat.builtin"].mean().to_frame().reset_index()
communication=data_k.groupby( ['id', pd.Grouper(key='time', freq='1H')] )["appCat.communication"].mean().to_frame().reset_index()
entertainment=data_k.groupby( ['id', pd.Grouper(key='time', freq='1H')] )["appCat.entertainment"].mean().to_frame().reset_index()
finance=data_k.groupby( ['id', pd.Grouper(key='time', freq='1H')] )["appCat.finance"].mean().to_frame().reset_index()
game=data_k.groupby( ['id', pd.Grouper(key='time', freq='1H')] )["appCat.game"].mean().to_frame().reset_index()
office=data_k.groupby( ['id', pd.Grouper(key='time', freq='1H')] )["appCat.office"].mean().to_frame().reset_index()
other=data_k.groupby( ['id', pd.Grouper(key='time', freq='1H')] )["appCat.other"].mean().to_frame().reset_index()
social=data_k.groupby( ['id', pd.Grouper(key='time', freq='1H')] )["appCat.social"].mean().to_frame().reset_index()
travel=data_k.groupby( ['id', pd.Grouper(key='time', freq='1H')] )["appCat.travel"].mean().to_frame().reset_index()
unknown=data_k.groupby( ['id', pd.Grouper(key='time', freq='1H')] )["appCat.unknown"].mean().to_frame().reset_index()
utilities=data_k.groupby( ['id', pd.Grouper(key='time', freq='1H')] )["appCat.utilities"].mean().to_frame().reset_index()
weather=data_k.groupby( ['id', pd.Grouper(key='time', freq='1H')] )["appCat.weather"].mean().to_frame().reset_index()
call=data_k.groupby( ['id', pd.Grouper(key='time', freq='1H')] )["call"].mean().to_frame().reset_index()
screen=data_k.groupby( ['id', pd.Grouper(key='time', freq='1H')] )["screen"].mean().to_frame().reset_index()
sms=data_k.groupby( ['id', pd.Grouper(key='time', freq='1H')] )["sms"].mean().to_frame().reset_index()
...
dataframe["appCat.builtin"]=builtin["appCat.builtin"]
dataframe["appCat.communication"]=communication["appCat.communication"]
dataframe["appCat.entertainment"]=entertainment["appCat.entertainment"]
dataframe["appCat.finance"]=finance["appCat.finance"]
dataframe["appCat.game"]=game["appCat.game"]
dataframe["appCat.office"]=office["appCat.office"]
dataframe["appCat.other"]=other["appCat.other"]
dataframe["appCat.social"]=social["appCat.social"]
dataframe["appCat.travel"]=travel["appCat.travel"]
dataframe["appCat.unknown"]=unknown["appCat.unknown"]
dataframe["appCat.utilities"]=utilities["appCat.utilities"]
dataframe["appCat.weather"]=weather["appCat.weather"]
dataframe["call"]=call["call"]
dataframe["screen"]=screen["screen"]
dataframe["sms"]=sms["sms"]

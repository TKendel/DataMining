...
x_train, x_test, y_train, y_test = train_test_split(X, Y, test_size=0.001, shuffle=False)#random_state=1 *****    #test_size=0.2 test_size=0.0001
...
#is_unbalace=True
model = LGBMRanker(objective="lambdarank",n_estimators=n, force_row_wise=True, seed=1, max_bin=500, learning_rate=lr) #The model is seeded*****   max_bin=255#max_bin=500
...
#extra fweatures
#******This was the previous model, NOTE, it is wrong, as it is using the =data_df['comp1_rate'] instead of the test_df
